...
class VApplication : public IDetour
{
	...
	{
		LogFunAdr("CModAppSystemGroup::Main", p_CModAppSystemGroup__Main.GetPtr()); // engine.dll + 0x1C64F0
		LogFunAdr("CModAppSystemGroup::Create", p_CModAppSystemGroup__Create.GetPtr()); // engine.dll + 0x1C4E40
	}
	virtual void GetFun(void) const
	{
		p_CModAppSystemGroup__Main = g_pEngineDll->FindPatternSIMD("40 53 48 83 EC 20 80 B9 A8 00 00 00 00 48 8B 0D");
		v_CModAppSystemGroup__Main = p_CModAppSystemGroup__Main.RCast<int(*)(void*,void*)>();

		p_CModAppSystemGroup__Create = g_pEngineDll->FindPatternSIMD("48 89 4C 24 08 55 56 57 41 54 41 55 41 56 41 57 48 8B EC 48 83");
