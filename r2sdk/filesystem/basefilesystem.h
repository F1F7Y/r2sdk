...
class VBaseFileSystem : public IDetour
{
	...
	virtual void GetFun(void) const
	{
		...
		p_CBaseFileSystem__LoadFromCache = g_pFSStdioDll->FindPatternSIMD("40 53 48 81 EC 40 02 00");
		v_CBaseFileSystem__LoadFromCache = p_CBaseFileSystem__LoadFromCache.RCast<bool(*)(void* self, char* pszFilePath, void* pResult)>();

		p_CBaseFileSystem__MountVPKFile = g_pFSStdioDll->FindPatternSIMD("48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 57 48 81 EC 50 02 00 00 48 8B");
		v_CBaseFileSystem__MountVPKFile = p_CBaseFileSystem__MountVPKFile.RCast<VPKData_t*(*)(void* self, const char* pszVpkPath)>();

		p_CBaseFileSystem__UnmountVPKFile = g_pFSStdioDll->FindPatternSIMD("48 89 5C 24 08 57 48 83  EC 20 48 8B DA 48 8B F9 48 8D");
		v_CBaseFileSystem__UnmountVPKFile = p_CBaseFileSystem__UnmountVPKFile.RCast<const char*(*)(void* self, const char* pszVpkPath)>();

		p_CBaseFileSystem__GetMountedVPKHandle = g_pFSStdioDll->FindPatternSIMD("40 53 48 83 EC 20 48 8B D9 E8 F2 0C 00 00 85 C0");
